...
class ValidationTest {
    ...
    void testAdvancedValidate() {
        ...
        Map<String, List<String>> expected3 = Map.of("country", List.of("length less than 4"), "city", List.of("can not be null", "length less than 2"),"street", List.of("can not be null"),"houseNumber", List.of("can not be null"));
        assertThat(result3).isEqualTo(expected3);
    }
    // END
}
