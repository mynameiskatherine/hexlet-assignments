...
public class ProductSpecification {
    public Specification<Product> build(ProductParamsDTO params) {
        return withTitleContents(params.getTitleCont())
    ...
    private Specification<Product> withTitleContents(String titleContents) {
        return (root, query, cb) -> titleContents == null ? cb.conjunction() : cb.like(root.get("title"), titleContents);
    }
